            ...
            <main className="font-mono">
                ...
                <section id="home" className="font-mono w-full  flex flex-col justify-center items-center min-h-screen pt-20">
                    <div className="max-w-xl w-full px-4 text-center">
                        ...
                        <p className="text-gray-500 mb-6 text-sm">I’m a software developer from Maldives with a keen eye for detail and
...
and am friendly, calm, and adaptable to various work environments</p>
                        <a href="mailto:moominraahil@gmail.com">
                            <button className=" duration-200 scale-95 hover:scale-100 bg-[#1B1B1B] hover:bg-[#181818] text-gray-200 font-semibold py-4 px-12 rounded-md text-sm shadow-lg shadow-gray-700/15 transition-all">
                                contact me
